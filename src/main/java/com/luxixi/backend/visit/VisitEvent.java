...
public class VisitEvent {
    ...
    @PrePersist void onCreate() { visitedAt = BeijingTime.now(); }
    ...
    public void setGeoRegion(String v){geoRegion=v;} public Long getId(){return id;} public LocalDateTime getVisitedAt(){return visitedAt;}
}
